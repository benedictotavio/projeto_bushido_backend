...
class AlunoControllerTest {
    ...
    void deveBuscarAluno() {
        ...
        when(alunoServices.buscarAluno(nome, rg, page, size, sortOrder, sortBy)).thenReturn(List.of(alunoDTOResponse));

        // Act
        ResponseEntity<List<AlunoDTOResponse>> responseEntity = alunoController.buscarAluno(rg, nome, page, size, sortBy, sortOrder);
    ...
    void deveEditarAluno(){
        ...
        when(alunoServices.editarAlunoPorRg(aluno.getRg(), updateAlunoDTORequest)).thenReturn("Aluno editado com sucesso!");

        // Act
        ResponseEntity<SuccessPutResponse> responseEntity = alunoController.editarAluno(aluno.getRg(), updateAlunoDTORequest);
    ...
    void deveAdicnarUmNovoResponsavel(){
        ...
        when(alunoServices.adicionarResponsavel(aluno.getRg(), responsavelDTORequest)).thenReturn(new ResponsavelDTOResponse(
        ...
        // Act
        ResponseEntity<SuccessPostResponse> responseEntity = alunoController.adicionarResponsavel(aluno.getRg(), responsavelDTORequest);
    ...
    void deveRemoverResponsavel() {
        ...
        // Mock service method
        when(alunoServices.removerResponsavel(aluno.getRg(), responsavelDTORequest.cpf())).thenReturn(String.valueOf(aluno.getResponsaveis().size()));

        // Act
        ResponseEntity<SuccessDeleteResponse> responseEntity = alunoController.removerResponsavel(aluno.getRg(), responsavelDTORequest.cpf());
    ...
    void deveAdicionarFaltaAoAluno() {
        ...
        // Mock service method
        when(alunoServices.adicionarFaltaDoAluno(rg, faltaDTORequest, data)).thenReturn(additionMessage);

        // Act
        ResponseEntity<SuccessPostResponse> responseEntity = alunoController.adicionarFaltaAoAluno(faltaDTORequest, rg, data);

        // Assert
        assertEquals(HttpStatus.OK, responseEntity.getStatusCode());

        // Verify that the service method was called with the correct arguments
        verify(alunoServices).adicionarFaltaDoAluno(rg, faltaDTORequest, data);
    ...
    void deveRetirarFaltaAoAluno() {
        ...
        // Mock service method
        when(alunoServices.retirarFaltaDoAluno(rg, data)).thenReturn(removalMessage);

        // Act
        ResponseEntity<SuccessDeleteResponse> responseEntity = alunoController.retirarFaltaAoAluno(data, rg);

        // Assert
        assertEquals(HttpStatus.OK, responseEntity.getStatusCode());

        // Verify that the service method was called with the correct arguments
        verify(alunoServices).retirarFaltaDoAluno(rg, data);
    ...
    void deveAdicionarDeficiencia() {
        ...
        // Mock service method
        when(alunoServices.adicionarDeficiencia(rg, deficiencia)).thenReturn(deficiencia);

        // Act
        ResponseEntity<SuccessPostResponse> responseEntity = alunoController.adicionarDeficiencia(rg, deficiencia);

        // Assert
        assertEquals(HttpStatus.OK, responseEntity.getStatusCode());

        // Verify that the service method was called with the correct arguments
        verify(alunoServices).adicionarDeficiencia(rg, deficiencia);
    ...
    void deveRemoverDeficiencia() {
        ...
        // Mock service method
        when(alunoServices.removerDeficiencia(rg, deficiencia)).thenReturn(deficiencia);

        // Act
        ResponseEntity<SuccessDeleteResponse> responseEntity = alunoController.removerDeficiencia(rg, deficiencia);

        // Assert
        assertEquals(HttpStatus.OK, responseEntity.getStatusCode());

        // Verify that the service method was called with the correct arguments
        verify(alunoServices).removerDeficiencia(rg, deficiencia);
    ...
    void deveAdicionarAcompanhamentoSaude() {
        ...
        // Mock service method
        when(alunoServices.adicionarAcompanhamentoSaude(rg, acompanhamento)).thenReturn(acompanhamento);

        // Act
        ResponseEntity<SuccessPostResponse> responseEntity = alunoController.adicionarAcompanhamentoSaude(rg, acompanhamento);

        // Assert
        assertEquals(HttpStatus.OK, responseEntity.getStatusCode());

        // Verify that the service method was called with the correct arguments
        verify(alunoServices).adicionarAcompanhamentoSaude(rg, acompanhamento);
    ...
    void deveRemoverAcompanhamentoSaude() {
        ...
        // Mock service method
        when(alunoServices.removerAcompanhamentoSaude(rg, acompanhamento)).thenReturn(acompanhamento);

        // Act
        ResponseEntity<SuccessDeleteResponse> responseEntity = alunoController.removerAcompanhamentoSaude(rg, acompanhamento);

        // Assert
        assertEquals(HttpStatus.OK, responseEntity.getStatusCode());
        verify(alunoServices).removerAcompanhamentoSaude(rg, acompanhamento);
