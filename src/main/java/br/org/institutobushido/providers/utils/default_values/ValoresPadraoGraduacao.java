package br.org.institutobushido.providers.utils.default_values;

public class ValoresPadraoGraduacao {
    private ValoresPadraoGraduacao() {
    }

    public static final int PRIMEIRO_KYU = 7;
    ...
    public static final int NUMERO_MINIMO_DE_SEMANAS = 1;
    public static final int CARGA_HORARIA_SEMANAL_HORAS = 3;
}
