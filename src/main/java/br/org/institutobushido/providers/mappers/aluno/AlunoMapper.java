...
public class AlunoMapper {
        ...
        public static AlunoDTOResponse mapToAlunoDTOResponse(Aluno aluno) {
                ...
                return AlunoDTOResponse.builder()
                                ...
                                .withDadosEscolares(DadosEscolaresMapper
                                                .mapToDadosEscolaresDTOResponse(aluno.getDadosEscolares()))
                                .withGraduacao(GraduacaoMapper.mapToListGraduacaoDTOResponse(aluno.getGraduacao()))
                                .withHistoricoSaude(HistoricoSaudeMapper
                                                .mapToHistoricoSaudeDTOResponse(aluno.getHistoricoSaude()))
